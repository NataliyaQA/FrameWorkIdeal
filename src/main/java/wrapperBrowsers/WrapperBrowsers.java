...
public class WrapperBrowsers {
    private static WebDriver driver = null;
    private static FluentWait<WebDriver> wait = null;

    private WrapperBrowsers() throws InterruptedException {
...
//                        .usingDriverExecutable(new File(System.setProperty(
//                                "webdriver.chrome.driver", "src/main/resources/drivers/chromedriver.exe")))
//                        .usingAnyFreePort()
//                        .build();
//                try {
